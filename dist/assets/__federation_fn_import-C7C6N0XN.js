...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BjdAhW7f.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-Cvljju5w.js', import.meta.url).href),import:true},'react-i18next':{get:()=>()=>__federation_import(new URL('__federation_shared_react-i18next-VJc1t7wV.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-Dox7ov88.js', import.meta.url).href),import:true},'raviger':{get:()=>()=>__federation_import(new URL('__federation_shared_raviger-Dnrm-l7I.js', import.meta.url).href),import:true}};
